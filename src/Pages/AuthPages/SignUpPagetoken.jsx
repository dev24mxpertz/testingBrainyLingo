...
import { SignUp_user, SignUp_user_via_token, Signin_user } from "../../store/Actions/Authactions.js";
import { GoogleLogin } from "@react-oauth/google";
import { jwtDecode } from "jwt-decode";
import { toast } from "react-toastify";


function SignUpPagetoken() {

    const {token}  =  useParams()

//   return <div style={{ color: "white" }}>{token}</div>;
  ...
  //  console.log(isAuthenticated, userType, "-----------------------------user");
